        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-6 col-sm-9">
                <div class="text-center " style="margin-top: 8rem;">
                    ...
                    <img src="{{url('/assets/img/500.png')}}" alt="Server Error" width="360px">
                    <h2 class="text">Kesalahan Server</h2>
                    <p>Mohon maaf, terjadi kesalahan saat melakukan permintaan.</p>
                </div>
            </div>
        </div>
    </div>
