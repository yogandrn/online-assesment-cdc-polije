...
@extends('users.main')
  ...
  <div class="row justify-content-center mx-auto px-4" style="margin-top: 3rem; ">
    <div class="col-xl-9 col-lg-9 col-md-10 col-sm-11 px-sm-4 px-lg-5 py-4 border rounded shadow-lg" style="background-color: #fff;margin-bottom: 4rem;">
        <br>
        ...
        <div class="mt-4 mb-4" style="border: 0.2px solid #818181;"></div>
          ...
          <div class="progress-container progress-warning">
              <span class="progress-badge" style="color:#00081d; font-size: 0.75rem">Presentase</span>
              <div class="progress">
