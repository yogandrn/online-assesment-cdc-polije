...
<div class="container">
  <div class="container row justify-content-between " style="margin-top: 3rem; margin-bottom: 4rem;">
    <div class="col-xl-4 col-lg-4 col-md-5 col-sm-12 container rounded shadow-lg  "  style="background-color: beige;">
      ...
      <div class="px-2">
        ...
        <a href="/users/profile/{{auth()->user()->id}}/edit" class="btn btn-primary w-100 mb-3 mt-3">Edit</a>
      </div>
    </div>
    <div class="col-xl-7 col-lg-7 col-md-6 col-sm-12 container rounded shadow-lg pb-4" style="background-color: beige;">
      ...
      <div class="row justify-content-around px-4">
        <div class="col-lg-5 col-md-12 px-4 py-3 img-raised rounded" style="border: 2px solid #25407e; max-width: 80%;">
